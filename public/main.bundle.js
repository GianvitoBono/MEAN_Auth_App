...
var ValidateService = (function () {
    ...
    ValidateService.prototype.validateRegister = function (user) {
        if (user.name == undefined || user.email == undefined || user.username == undefined || user.password == undefined || user.re_password == undefined) {
            return false;
        }
        else {
            return true;
    ...
    ValidateService.prototype.validPassword = function (password, re_password) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__guards_auth_guard__ = __webpack_require__(514);
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.succes) {
                ...
                _this.flashMessage.show('Accesso consentito', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(["dashboard"]);
            }
            else {
                _this.flashMessage.show('Nome Utente o Password errati', { cssClass: 'alert-danger', timeout: 3000 });
            }
        });
    };
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.succes) {
                _this.flashMessage.show('Registrazione avvenuta con successo', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessage.show('Errore nella registrazione dell\'account, riprova più tardi', { cssClass: 'alert-danger', timeout: 3000 });
...
module.exports = "<div *ngIf=\"user\">\n  <h2 class=\"page-header\">{{user.name}}</h2>\n  <ul class=\"list-group\">\n    <li class=\"list-group-item\">Nome utente: {{user.username}}</li>\n    <li class=\"list-group-item\">Email: {{user.email}}</li>\n  </ul>\n</div>"
